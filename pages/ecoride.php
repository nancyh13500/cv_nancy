...
<header class="hero-section" style="min-height: 400px;">
    <div class="container">
        <h1 class="name display-4 fw-bold">Ecoride</h1>
        <h3 class="lead">Covoiturage écologique et responsable</h3>
    </div>
</header>
    ...
    <div class="container px-4 py-5">
        <div class="row flex-lg-row align-items-center g-5 py-5">
            <div class="col-md-6">
                ...
                <p class="pt-3">Ecoride</p>
                <p class="pt-3">Cette application permet aux utilisateurs de consulter un covoiturage écologique et responsable.</p>
            ...
            <div class="col-md-6">
                <img src="../assets/img/ecoride fond blanc.png" alt="Ecoride" class="img-fluid d-block mx-auto logo-nh">
            </div>
        </div>
    </div>
</section>
